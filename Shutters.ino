...
{
  Serial.print("Shutters "); Serial.print(device_name); 
  Serial.print(" state: Shutters ");
  if (state) 
  {
    Serial.println("ON");
  } 
  ...
  if ( (strcmp(device_name, "Shutter") == 0) ) 
  {
    if (state) 
    {
